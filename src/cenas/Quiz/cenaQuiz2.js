...
// Cria a classe "cenaQuiz2" que herda Phaser.Scene
export class cenaQuiz2 extends Phaser.Scene {

    // A cena utiliza a chave "cenaQuiz2" para se referir a essa cena
    constructor() {
        super({key: 'cenaQuiz2'})
